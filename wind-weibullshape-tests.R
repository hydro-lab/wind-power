...
#skip the first 4 rows of data as they are actually the titles of the variables
x <- read.csv("https://duq.box.com/shared/static/hmths6ofu40ox2n9shvrdydawd57e7v2.dat", skip = 4)
